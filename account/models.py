...
class User(AbstractUser):
    ...
    def create_activation_code(self):
        ...
        code = get_random_string(length=8,allowed_chars='wertyuiopsdfghjkmnbvcxsdfghjpoiuytKJHGFDSAZXCVBNMPOIUYTREWQ')
    ...
    def send_activation_code(self):
        ...
        send_mail('Activate account', message, 'admin@admin.com',recipient_list=[self.email])  #Activate account - тема сообщения 'subject'
